...
public:
	...
	FileUpdateChecker()
	{
//		MY_TRACE("FileUpdateChecker::FileUpdateChecker()\n");
	}

	FileUpdateChecker(LPCWSTR filePath)
	{
//		MY_TRACE("FileUpdateChecker::FileUpdateChecker(%ws)\n", filePath);
	...
	BOOL isFileUpdated()
	{
//		MY_TRACE("FileUpdateChecker::isFileUpdated()\n");
...
public:
	...
	FileUpdateCheckers()
	{
//		MY_TRACE("FileUpdateCheckers::FileUpdateCheckers()\n");
	}

	void clear()
	{
//		MY_TRACE("FileUpdateCheckers::clear()\n");
	...
	{
//		MY_TRACE("FileUpdateCheckers::add(%ws)\n", filePath);
	...
	BOOL isFileUpdated()
	{
//		MY_TRACE("FileUpdateCheckers::isFileUpdated()\n");
