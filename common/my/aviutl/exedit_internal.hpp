...
#pragma pack(pop)
	...
	struct ExEditInternal
	{
		...
		BOOL init()
		{
			...
			tools::assign(address.variable.aviutl_window, exedit + 0x135C6C);
			tools::assign(address.variable.exedit_window, exedit + 0x177A44);
			tools::assign(address.variable.setting_dialog, exedit + 0x1539C8);
			...
			tools::assign(address.variable.selection_visual, + 0x00146270 + 0x04);
