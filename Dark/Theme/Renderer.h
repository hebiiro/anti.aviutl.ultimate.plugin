...
namespace fgo::dark::theme
{
	struct Renderer
	{
		virtual HRESULT onDrawThemeParentBackground(HWND hwnd, HDC dc, LPCRECT rc)
		{
		...
		virtual HRESULT onDrawThemeBackground(HTHEME theme, HDC dc, int partId, int stateId, LPCRECT rc, LPCRECT rcClip)
		{
		...
		virtual HRESULT onDrawThemeBackgroundEx(HTHEME theme, HDC dc, int partId, int stateId, LPCRECT rc, const DTBGOPTS* options)
		{
		...
		virtual HRESULT onDrawThemeText(HTHEME theme, HDC dc, int partId, int stateId, LPCWSTR text, int c, DWORD textFlags, DWORD textFlags2, LPCRECT rc)
		{
		...
		virtual HRESULT onDrawThemeTextEx(HTHEME theme, HDC dc, int partId, int stateId, LPCWSTR text, int c, DWORD textFlags, LPRECT rc, const DTTOPTS* options)
		{
		...
		virtual HRESULT onDrawThemeIcon(HTHEME theme, HDC dc, int partId, int stateId, LPCRECT rc, HIMAGELIST imageList, int imageIndex)
		{
		...
		virtual HRESULT onDrawThemeEdge(HTHEME theme, HDC dc, int partId, int stateId, LPCRECT destRect, UINT edge, UINT flags, LPRECT contentRect)
		{
