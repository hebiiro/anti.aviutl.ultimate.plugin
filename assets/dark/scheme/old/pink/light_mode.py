...
# 『[旧形式] ピンク』のライトモードの設定です。

#
# 指定されたキーカラーを補正して返します。
#
def KEY(color, add):
	return ADD(color, 0, add, 0)
...
# よく使う配色を定義します。
#
normal_fill_color = CLR(255, 245, 255)
normal_text_color = CLR(0, 0, 0)
normal_border_color = CLR(50, 0, 0)
disabled_text_color = CLR(120)
key_fill_color = CLR(255, 220, 255)
key_text_color = CLR(0, 0, 0)
key_border_color = CLR(100, 50, 100)
