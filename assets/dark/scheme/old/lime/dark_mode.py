...
# よく使う配色を定義します。
#
normal_fill_color = CLR(25)
normal_text_color = CLR(200)
normal_border_color = CLR(50, 100, 50)
disabled_fill_color = CLR(50)
disabled_text_color = CLR(120)
disabled_border_color = CLR(0)
key_fill_color = CLR(120, 255, 120)
key_text_color = CLR(0)
key_border_color = CLR(0, 50, 0)
...
if (stuff):
	stuff.fill.color = ADD(disabled_fill_color, 0)
	stuff.text.color = ADD(disabled_text_color, 0)
	stuff.text.shadow_color = text_shadow(stuff)
	stuff.border.color = ADD(disabled_border_color, 0)
	stuff.border.width = border_width
	stuff.etc.ellipse = ellipse
...
if (stuff):
	...
	stuff.text.color = KEY(key_text_color, 0)
	stuff.text.shadow_color = text_shadow(stuff)
	stuff.border.color = KEY(key_border_color, -80)
	stuff.border.width = border_width
	stuff.etc.ellipse = ellipse
...
if (stuff):
	stuff.fill.color = ADD(disabled_fill_color, 20)
	stuff.border.color = ADD(disabled_border_color, 0)
	stuff.border.width = 1
...
if (stuff):
	stuff.fill.color = ADD(key_fill_color, -80)
