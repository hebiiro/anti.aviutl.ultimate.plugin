...
# 『[旧形式] cherry』のダークモードの設定です。
# はくしんさんの『CherryDark』を元に作成しています。

# オリジナルの色が明るすぎるので調整しています。
key_fill_color = utils.lerp_color(CLR("#FF5975"), CLR("#3E2530"), 0.5)
...
if (stuff):
	stuff.fill.color = CLR("#3E2530")
	stuff.text.color = CLR("#ECEFF4")
	stuff.border.color = CLR("#FF5975")
...
if (stuff):
	stuff.fill.color = ADD(CLR("#1C1C25"), +7)
...
exedit.xor_pen.color = CLR("#FF745A")

# アイコン

icon = dark.exports.icon_manager
icon.change_color("", CLR("#000"), CLR("#FF7359"))
