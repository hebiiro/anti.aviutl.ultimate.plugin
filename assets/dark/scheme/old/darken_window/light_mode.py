...
if (stuff):
	stuff.fill.color = ADD(CLR("#fff"), -7)
...
exedit.xor_pen.color = CLR("#f00")

# アイコン

icon = dark.exports.icon_manager
icon.change_color("", CLR("#000"), CLR("#c00"))
