...
if (stuff):
	stuff.fill.color = CLR(230, 240, 255)
...
if (stuff):
	...
	stuff.text.color = disabled_text_color
	stuff.text.shadow_color = text_shadow(stuff)
	stuff.border.color = CLR(180, 200, 255)
	stuff.border.width = border_width
	stuff.etc.ellipse = ellipse
...
if (stuff):
	stuff.fill.color = CLR(200, 220, 255)
	stuff.text.color = CLR(0)
	stuff.text.shadow_color = text_shadow(stuff)
	stuff.border.color = CLR(100, 110, 200)
	stuff.border.width = border_width
	stuff.etc.ellipse = ellipse
...
if (stuff):
	stuff.fill.color = CLR(190, 210, 255)
	stuff.text.color = CLR(0)
	stuff.text.shadow_color = text_shadow(stuff)
	stuff.border.color = CLR(0, 0, 50)
	stuff.border.width = border_width
...
if (stuff):
	stuff.fill.color = CLR(240, 245, 255)
	stuff.text.color = normal_text_color
	stuff.text.shadow_color = text_shadow(stuff)
...
if (stuff):
	stuff.fill.color = CLR(220, 230, 255)
...
if (stuff):
	stuff.fill.color = CLR(210, 230, 255)
	stuff.border.color = CLR(160, 180, 255)
	stuff.border.width = 1
	stuff.etc.ellipse = ellipse
...
if (stuff):
	stuff.fill.color = CLR(220, 230, 255)
	stuff.border.color = CLR(50, 80, 100)
	stuff.border.width = 1
...
if (stuff):
	stuff.fill.color = CLR(120, 130, 160)

## 奇数レイヤー背景のアクティブ状態
stuff = utils.create_stuff("exedit_odd_layer_background_active")
if (stuff):
	stuff.fill.color = CLR(215, 225, 255)
...
exedit.group.color = CLR(60, 240, 60)
