...
* 要望・不具合報告は[イシュー](https://github.com/hebiiro/anti.aviutl.ultimate.plugin/issues)を使用してください。
* **ただし、次のルールを守ってください。**
	...
	* ✏️ ネガティブな言葉を使用しない。
		* 「この機能は不便」などと言われても嫌な気持ちになるだけで建設的なことが何もない。「こういう機能を追加してほしい」とか「こういうふうに変更してほしい」とだけ言えばいい。余計なことは言わないようにする。
