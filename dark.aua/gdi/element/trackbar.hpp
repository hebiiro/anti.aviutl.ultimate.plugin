...
namespace apn::dark::gdi
{
	struct TrackBarRenderer : Renderer
	{
		virtual LRESULT on_subclass_proc(MessageState* current_state) override
		{
			...
			case WM_ERASEBKGND:
				{
//					MY_TRACE_FUNC("WM_ERASEBKGND, {:#010x}, {:#010x}, {:#010x}, {:#010x}", current_state->hwnd, current_state->message, current_state->wParam, current_state->lParam);
			...
			case WM_LBUTTONDOWN:
				{
//					MY_TRACE_FUNC("WM_LBUTTONDOWN, {:#010x}, {:#010x}, {:#010x}, {:#010x}", current_state->hwnd, current_state->message, current_state->wParam, current_state->lParam);
