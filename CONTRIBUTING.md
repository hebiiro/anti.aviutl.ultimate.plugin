...
* controller + model + viewの3層で構成されます。

### controller

* 一人称のクラス群です。
* データを参照または変更する処理などが所属します。

### model

* 二人称のクラス群です。
* 参照または変更されるデータなどが所属します。

### view

* 三人称のクラス群です。
* ユーザーに許可を求めたり結果を報告したりする処理が所属します。

## PSCモデル

* property + state + contextの3層で構成されます。

### property

* 最も揮発性の低い固体データです。
* ファイル入出力に使用される生のデータが所属します。
* 例えばGDIなら色やペンの太さです。

### state

* propertyより流動的な液体データです。
* propertyが変更された時に更新されるキャッシュなどが所属します。
* 例えばGDIならペンやブラシです。
