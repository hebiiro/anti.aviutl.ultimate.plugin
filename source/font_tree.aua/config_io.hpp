...
namespace apn::font_tree
{
	...
	inline struct ConfigIO : StdConfigIOUseHive<hive>
	{
		...
		virtual BOOL read_node(n_json& root) override
		{
			...
			read_string(root, "display_name_format_v2", hive.favorite.display_name_format);
			read_string(root, "separator_format", hive.favorite.separator_format);
		...
		virtual BOOL write_node(n_json& root) override
		{
			...
			write_string(root, "display_name_format_v2", hive.favorite.display_name_format);
			write_string(root, "separator_format", hive.favorite.separator_format);
