	...
	inline struct ComboBoxRenderer : Renderer
	{
		...
		HRESULT on_draw_theme_background(HTHEME theme, HDC dc, int part_id, int state_id, LPCRECT rc, LPCRECT rc_clip) override
		{
...

			{
				switch (part_id)
				{
				case CP_BORDER: border_state_id = state_id; break;
				case CP_READONLY: readonly_state_id = state_id; break;
				case CP_DROPDOWNBUTTONRIGHT: dropdown_state_id = state_id; break;
				}
